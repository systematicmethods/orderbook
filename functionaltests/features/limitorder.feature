...
Feature: Limit Orders
  ...
  Scenario: Buy and sell limit orders
    ...
    When users send orders with:
      ...
      | NewOrder     | John_01   | ABV        | Buy  | Limit   | John_01 | 1.03  | 1000 |          | GoodTillCancel |
      | NewOrder     | Bill_01   | ABV        | Sell | Limit   | Bill_01 | 1.05  | 2000 |          | GoodTillCancel |
    ...
    And executions should be:
      ...
      | NewOrderAck  | John_01   | ABV        | Buy  | Limit   | John_01 | 1.03  | 1000 |          | GoodTillCancel | 0       |           | 0      | New    |        | Not Null | Not Null |
      | NewOrderAck  | Bill_01   | ABV        | Sell | Limit   | Bill_01 | 1.05  | 2000 |          | GoodTillCancel | 0       |           | 0      | New    |        | Not Null | Not Null |
