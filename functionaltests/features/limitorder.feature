...
Feature: Limit Orders
  ...
  Scenario: Buy and sell limit orders
    Given An order book for instrument "EURUSD"
    When users send orders with:
      | Event        | ClientID  | Instrument | Side | OrdType | ClOrdID | Price | Qty  | ExpireOn | TimeinForce |
      | NewOrder     | John_01   | EURUSD     | Buy  | Limit   | John_01 | 1.03  | 1000 |          |             |
      | NewOrder     | Bill_01   | EURUSD     | Sell | Limit   | Bill_01 | 1.05  | 2000 |          |             |
    ...
    And executions should be:
      ...
      | NewOrderAck  | John_01   | EURUSD     | Buy  | Limit   | John_01 | 1.03  | 1000 |          |             | 0      | New    |        | Not Null | Not Null |
      | NewOrderAck  | Bill_01   | EURUSD     | Buy  | Limit   | Bill_01 | 1.05  | 2000 |          |             | 0      | New    |        | Not Null | Not Null |
