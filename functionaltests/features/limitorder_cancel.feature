...
Feature: Limit Order Cancel
  ...
  Scenario: Buy and sell limit orders and cancel
    ...
    And executions should be:
      ...
      | Cancelled    | John_01   | ABV        | Buy  | Limit   | John_02o | 1.03  | 1000 |          | GoodTillCancel | John_01o    | 0       |           | 0      | Cancelled | Cancelled |        | Not Null | Not Null |           |              |
      | Cancelled    | Bill_01   | ABV        | Sell | Limit   | Bill_02o | 1.05  | 2000 |          | GoodTillCancel | Bill_01o    | 0       |           | 0      | Cancelled | Cancelled |        | Not Null | Not Null |           |              |
